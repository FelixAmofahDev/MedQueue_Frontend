  ...
  Widget _buildHeroBanner(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: config.gradientColors.first.withOpacity(0.35),
            blurRadius: 24,
            spreadRadius: -4,
    ...
    return AnimatedBuilder(
      ...
      builder: (_, __) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: config.color.withOpacity(isCalled ? 0.5 : 0.25),
...
class _Divider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
        width: 1, height: 48, color: AppColors.borderColor.withOpacity(0.4));
  }
}
