                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isAvailable ? AppColors.successGreen.withOpacity(0.1) : AppColors.errorRed.withOpacity(0.1),
    ...
    return Dismissible(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          padding: const EdgeInsets.all(12),
          decoration: BoxDecoration(
            color: isRead ? AppColors.backgroundGray : _getTypeColor().withOpacity(0.05),
            borderRadius: BorderRadius.circular(8),
            border: Border.all(
